...
def counter(user):
    number_of_available_promocodes = cache.get('number_of_available_promocodes')
    if not number_of_available_promocodes:
        ...
        cache.set('number_of_available_promocodes', number_of_available_promocodes, 10)
